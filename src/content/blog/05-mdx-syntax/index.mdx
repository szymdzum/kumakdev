...
featuredImage: "/images/blog/mdx-syntax.jpg"
imageAlt: "MDX syntax guide"
imageCaption: "Learn how to use MDX in Astro Micro"
tags:
  - reference
  - mdx
  - guide
...
> **Note:** Don't forget to use [client directives](https://docs.astro.build/en/reference/directives-reference/#client-directives) to make framework components interactive.
