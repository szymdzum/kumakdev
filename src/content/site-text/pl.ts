...
export const siteContent = {
	...
	projects: {
		...
		description:
			"Wybór moich ostatnich prac z zakresu projektowania i programowania.",
	...
	about: {
		sectionTitle: "O Mnie",
		profileImage:
			"https://placehold.co/400x400/111827/FFFFFF/png?text=JD&font=montserrat",
		imageAlt: "Jane Doe",
		paragraphs: [
	...
	newsletter: {
		...
		privacyNote:
			"Szanuję Twoją prywatność. Możesz zrezygnować w każdej chwili.",
	},
	...
	footer: {
		...
		copyright: (year: number) =>
			`© ${year} Jane Doe. Wszelkie prawa zastrzeżone.`,
		links: {
